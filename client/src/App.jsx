...
import DashboardAccountingSpecificMonthPage from './pages/DashboardAccountingSpecificMonthPage';
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/dashboard/accounting/specificMonth" element={authUser ? <DashboardAccountingSpecificMonthPage /> : <LogInPage/>} />
      </Routes>
      <Toaster 
        toastOptions={{
          error: {
